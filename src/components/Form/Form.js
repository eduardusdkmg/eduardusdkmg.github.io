...
import { addTodo }  from '../../store/actions/todoAction.js'
	...
	render () {
		...
		return (
			<>
				...
				<button className={`btn ${styleButtonNotes}`} onClick={() => this.onClickChoice('Note')}>Switch to Add Notes</button>
				<p className="mt-4">Add {this.state.choice}</p>
